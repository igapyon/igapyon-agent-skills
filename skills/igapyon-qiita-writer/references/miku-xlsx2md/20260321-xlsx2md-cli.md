...
もともとの `xlsx2md` は、`miku-xlsx2md.html` をブラウザで開いて使う GUI 中心のアプリです。そこに今回、Node から実行できる CLI を追加しました。つまり、画面から使うだけでなく、バッチ的にも利用できるようにしようとしたものです。
...
![74135A51-2588-4628-B164-F280E3D5DC5D.jpg](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/105739/da02c297-0f95-4905-91e1-ecae5b7eebd1.jpeg)
...
- ZIP のファイル出力
- `--table-detection-mode border` の利用
