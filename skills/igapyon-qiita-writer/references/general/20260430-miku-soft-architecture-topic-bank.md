...
このファイルは、`20260430-miku-soft-architecture-overview.md` で説明済みの内容を繰り返すための原稿ではありません。
...
### 候補 2: TypeScript から Java への straight conversion
...
### 候補 3: Agent Skills は単なるプロンプト集ではない
...
### 候補 4: MCP サーバーを protocol adapter として設計する
...
### 候補 5: 生成AI駆動開発における README / docs / TODO / workplace
