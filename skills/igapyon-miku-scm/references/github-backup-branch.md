...
Use this workflow when the user explicitly asks `igapyon-miku-scm` to create a local backup branch, or when another active `igapyon-miku-scm` workflow requires a backup branch before rewriting local history.
