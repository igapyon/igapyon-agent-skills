...
After `igapyon-miku-scm` is active, enter Release mode for similar wording such as `release textつくりたい`, `リリース文を作りたい`, `GitHub Release文を作りたい`, `release notes`, `リリースノート`, `リリース本文`, or `GitHub Release本文`.
