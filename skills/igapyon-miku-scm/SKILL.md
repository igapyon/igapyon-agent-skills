...
description: Use only when the user explicitly names `igapyon-miku-scm`, explicitly asks to apply the miku SCM workflow, or explicitly asks to perform Git, GitHub writing, GitHub Release, or version-management work under miku-soft SCM rules. Supports PR, Release, About, and public GitHub Issue drafting; human-approved new public Issue creation through `gh issue create`; PR soft-reset recommit; backup and branch-status workflows; date-based and Semantic Version increments; public GitHub Issue rewrite handoffs; and READONLY version, tag, Release, and asset audits. Do not activate for generic Git or GitHub questions, ordinary repository inspection, or release-note writing outside an explicit miku-soft SCM request.
---
...
- public GitHub Issue drafting, human-approved new-Issue creation, and human-approved existing-Issue body updates
...
11. For a new public GitHub Issue draft or an existing Issue rewrite, read [references/github-anonymous-readonly.md](references/github-anonymous-readonly.md) and [references/github-issue-rewrite-handoff.md](references/github-issue-rewrite-handoff.md). When the user explicitly requests registration of a reviewed new-Issue draft, also read [references/github-issue-create.md](references/github-issue-create.md) and use [scripts/github-issue-create.mjs](scripts/github-issue-create.mjs). When the user explicitly requests application of a reviewed existing-Issue body update, read [references/github-issue-update.md](references/github-issue-update.md) and use [scripts/github-issue-update.mjs](scripts/github-issue-update.mjs).
