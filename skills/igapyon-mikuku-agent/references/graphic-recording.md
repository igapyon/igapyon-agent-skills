...
`##` 見出しごとの画像生成対象は、記事本文の理解を助けるセクションに限ります。
次の末尾補足セクションは、原則として画像生成対象外にしてください。
...
これらは読者向けの導線、著者情報、公開管理、補足情報であり、本文理解のためのグラレコ説明画像は作りません。
...
新しい画像を生成するときも、キャラクターを再設計しないでください。変更してよいのは、場面、ポーズ、表情、構図、説明している内容だけです。
...
グラレコ画像では、指の本数や握りの形に破綻が出やすいため、みくくに物を持たせないでください。

既存画像や再生成候補で、みくくがペン、指し棒、マーカー、ノート、ボードなどを持つ構図になった場合は、手指の本数を検品対象にしてください。

次は問題として扱いません。

- 指がペン、マーカー、持ち物に隠れている
- 握り手のため一部の指が見えない
- 指が手の奥側、ペンの裏側、髪、袖、持ち物に隠れている
- 構図上、見えている指だけでは5本未満に見えるが、隠れている指として自然に説明できる

次はエラーとして扱います。

- 見えている指を数えると6本以上ある
- 親指とは別に余分な指が明確に描かれている
- 握りやペンの裏側では説明できない位置に余分な指がある
- 片手が複数の手に分裂して見える

エラーの場合は、公開用成果物として採用せず、旧画像を rejected backup として残し、再生成してください。
